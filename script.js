...
function clickOnProjects() {
    $('#projects').on('click', event => {
        $('.main').hide();
        $('.js-top').html(`<div class="js-project"><h1>Breaking Bad Quiz App</h1><div class="logos"><img class="first-logo" alt="html logo" src="/Users/hsy-53/projects/html.png"/><img class="second-logo" alt="css logo" src="/Users/hsy-53/projects/csslogo-2582747_960_720.png"/>
        ...
        <img class="intro-quiz" src="/Users/hsy-53/projects/Screen Shot 2019-07-13 at 8.10.53 PM.png" alt="quiz app intro image"/>
