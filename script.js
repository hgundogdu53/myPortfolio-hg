...
function clickOnProjects() {
    $('#projects').on('click', event => {
        ...
        <a target="_blank" href="https://github.com/hgundogdu53/Okie-Dokie-Recipe">Repo</a>
        <a target="_blank" href="https://hgundogdu53.github.io/Okie-Dokie-Recipe/">Live</a></div>
        </div>`);
    });
}
